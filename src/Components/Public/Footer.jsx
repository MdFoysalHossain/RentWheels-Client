            ...
            <div className="grid grid-cols-5 gap-10 py-10 text-white">
                ...
                <div className="text-left">
                    ...
                    <div className="mt-5 flex flex-col gap-4">
                        ...
                        <p className='flex gap-2 hover:text-primary underline underline-offset-4 decoration-primary cursor-pointer'><ReceiptText  className='text-primary ' /> Read Our Terms & Conditions</p>
                    </div>
                </div>
                <div className="text-left">
                    <h2 className='text-xl font-semibold'>Social Media</h2>
                    <div className="mt-5 flex flex-col gap-4    ">
                        <a href='https://www.facebook.com/'target='_blank' className='flex gap-2 hover:text-primary'><Facebook  className='text-primary' /> Facebook</a>
                        <a href='https://www.instagram.com/'target='_blank' className='flex gap-2 hover:text-primary'><Instagram  className='text-primary' /> Instagram</a>
